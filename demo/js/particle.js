...
function setColor(targ){
	if (grayScale){
		...
		var colorTint = Math.round(Math.random() * 8);
		...
		if (colorTint <= 1){
			...
			_g = 193;
			_b = 37;
                        targ.color = 'rgba(255,215,0,'+_a+')';
		} else if (colorTint == 2){
			_r = 0;
			_g = 209;
			_b = 255;	
			targ.color = 'rgba(139,90,0,'+_a+')';
		} else if (colorTint == 3){
			_r = 0;
			_g = 255;
			_b = 4;	
			targ.color = 'rgba(205,133,0,'+_a+')';
		} else if (colorTint == 4){
			_r = 100;
			_g = 0;
			_b = 255;
			targ.color = 'rgba(238,154,0,'+_a+')';
		} else if (colorTint == 5){
			_r = 255;
			_g = 70;
			_b = 0;
			targ.color = 'rgba(255,165,0,'+_a+')';
		} else if (colorTint == 6){
			_r = 255;
			_g = 70;
			_b = 0;
